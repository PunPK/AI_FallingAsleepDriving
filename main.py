...
def start_mode() :
    ...
    button = tk.Button(window, text="Start the program", command=open_program, font=("Arial", 16))
    button.pack()
    exit_button = tk.Button(window, text="Exit the program", command=exit_program, font=("Arial", 16))
    exit_button.pack()
    window.mainloop()
